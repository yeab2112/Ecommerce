            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              {latestOrder?.deliveryInfo ? (
                <div className="space-y-2">
                  <p className="font-medium">
                    {latestOrder.deliveryInfo.firstName}{' '}
                    {latestOrder.deliveryInfo.lastName}
                  </p>
                  <p>{latestOrder.deliveryInfo.address}</p>
                  <p>
                    {latestOrder.deliveryInfo.city}, {latestOrder.deliveryInfo.state}{' '}
                    {latestOrder.deliveryInfo.zipCode}
                  </p>
